    ...
    <>
      <section className="bg-[#3c5160] pt-[100px] pb-[100px] max-[560px]:py-[70px] max-[560px]:pb-[30px]">
        <div className="container">
          <h2 className="text-[28px] text-center tracking-[0.5px] mb-[40px] capitalize leading-[180%] text-white">
            Dinings
          </h2>
            ...
            <div className="grid grid-cols-12 gap-[40px] max-lg:gap-[20px]">
              ...
              <div className="col-span-7 max-lg:col-span-12 flex justify-end max-[1024px]:justify-start max-lg:my-[40px]">
                <div className="flex flex-col h-full gap-[24px] max-w-[580px] w-full justify-center px-4 max-lg:px-0">
                  ...
                  <h3 className="text-[22px] tracking-[0.5px] capitalize leading-[120%] text-white">
                    Habitat Bistro
                  </h3>
                  <p className="text-white/70 text-[14px] leading-[180%] tracking-[0.5px]">
                  ...
                  <div className="mt-[16px]">
                    <a
                      href={"#"}
                      className="px-[22px] py-[12px] bg-white text-[14px] text-[#1a1a1a] inline-block"
                    >
                      Discover More
                    </a>
                  </div>
